...
public class Selection {
    ...
    public static void SelectionSort(int[] lista){
        ...
        int menor;
        int auxiliar;
        for(int i = 0; i < selection1.tamanhoLista(lista); i++){
            menor = i;
            interacao++;
            for(int j = i+1; j < selection1.tamanhoLista(lista); j++){
                interacao++;
                if(lista[j] < lista[menor]){
                    menor = j;
                }
            }
            auxiliar = lista[menor];
            lista[menor] = lista[i];
            lista[i] = auxiliar;
            trocas++;
        }
