...
public class Shell {
    ...
    public static void shellSort(int[] lista){
        ...
        for (int incremento = shell1.tamanhoLista(lista) / 2; incremento > 0 ; incremento = incremento / 2) {
            interacao++;
            for (int i = incremento; i < shell1.tamanhoLista(lista); i++) {
                interacao++;
                int temporario = lista[i];
                int incrementoAtual;
                for (incrementoAtual = i; incrementoAtual >= incremento && lista[incrementoAtual - incremento] > temporario; incrementoAtual -= incremento) {
                    lista[incrementoAtual] = lista[incrementoAtual - incremento];
                    trocas++;
                    interacao++;
                }
                lista[incrementoAtual] = temporario;
                trocas++;
            }
        }
    }
